...
let morningNeedToDo = brushTeeth + uploadPhotos + chooseClothes + shower + goJogging + finishHomework + fixLunch
/*:
...
let likeToDo = workout + playGuitar + runnig

let totalTime = morningNeedToDo + likeToDo
/*:
